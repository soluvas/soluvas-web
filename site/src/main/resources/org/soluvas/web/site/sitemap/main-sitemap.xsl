		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					<h1>XML Sitemap</h1>
					<p class="expl">
						Generated by <a href="https://github.com/soluvas/soluvas-web">Soluvas Web</a> (adapted from <a href="https://yoast.com/">Yoast</a>), this is an XML Sitemap, meant for consumption by search engines.<br/>
