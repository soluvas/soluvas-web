...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Generic Page</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class GenericPageImpl extends EObjectImpl implements GenericPage {
	/**
	...
	protected EClass eStaticClass() {
		return SitePackage.Literals.GENERIC_PAGE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.GENERIC_PAGE__NAME, oldName, name));
	}
	...
	public EList<PageParam> getParams() {
		if (params == null) {
			params = new EObjectContainmentEList<PageParam>(PageParam.class, this, SitePackage.GENERIC_PAGE__PARAMS);
		}
		return params;
	}
	...
	public NotificationChain basicSetSection(Section newSection, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newSection, SitePackage.GENERIC_PAGE__SECTION, msgs);
		return msgs;
	}
	...
	public void setSection(Section newSection) {
		if (newSection != eInternalContainer() || (eContainerFeatureID() != SitePackage.GENERIC_PAGE__SECTION && newSection != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.GENERIC_PAGE__SECTION, newSection, newSection));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SitePackage.GENERIC_PAGE__SECTION:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SitePackage.GENERIC_PAGE__PARAMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SitePackage.GENERIC_PAGE__NAME:
				return getName();
			case SitePackage.GENERIC_PAGE__MOUNT_POINT:
