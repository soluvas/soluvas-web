 ...
 * <ul>
 *   <li>{@link org.soluvas.web.site.impl.ContentPageImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.ContentPageImpl#getMountPoint <em>Mount Point</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.ContentPageImpl#getParams <em>Params</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.ContentPageImpl#getSection <em>Section</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ContentPageImpl extends EObjectImpl implements ContentPage {
	/**
	...
	protected EClass eStaticClass() {
		return SitePackage.Literals.CONTENT_PAGE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.CONTENT_PAGE__NAME, oldName, name));
	}
	...
	public void setMountPoint(String newMountPoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.CONTENT_PAGE__MOUNT_POINT, oldMountPoint, mountPoint));
	}
	...
	public EList<PageParam> getParams() {
		if (params == null) {
			params = new EObjectContainmentEList<PageParam>(PageParam.class, this, SitePackage.CONTENT_PAGE__PARAMS);
		}
		return params;
	}
	...
	public Section getSection() {
		if (eContainerFeatureID() != SitePackage.CONTENT_PAGE__SECTION) return null;
	...
	public NotificationChain basicSetSection(Section newSection, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newSection, SitePackage.CONTENT_PAGE__SECTION, msgs);
		return msgs;
	}
	...
	public void setSection(Section newSection) {
		if (newSection != eInternalContainer() || (eContainerFeatureID() != SitePackage.CONTENT_PAGE__SECTION && newSection != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.CONTENT_PAGE__SECTION, newSection, newSection));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SitePackage.CONTENT_PAGE__SECTION:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SitePackage.CONTENT_PAGE__PARAMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SitePackage.CONTENT_PAGE__NAME:
				return getName();
			case SitePackage.CONTENT_PAGE__MOUNT_POINT:
