...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Raw Entity Table Page</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.soluvas.web.site.impl.RawEntityTablePageImpl#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public class RawEntityTablePageImpl extends EObjectImpl implements RawEntityTablePage {
	/**
	...
	protected EClass eStaticClass() {
		return SitePackage.Literals.RAW_ENTITY_TABLE_PAGE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.RAW_ENTITY_TABLE_PAGE__NAME, oldName, name));
	}
	...
	public EList<PageParam> getParams() {
		if (params == null) {
			params = new EObjectContainmentEList<PageParam>(PageParam.class, this, SitePackage.RAW_ENTITY_TABLE_PAGE__PARAMS);
		}
		return params;
	}
	...
	public NotificationChain basicSetSection(Section newSection, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newSection, SitePackage.RAW_ENTITY_TABLE_PAGE__SECTION, msgs);
		return msgs;
	}
	...
	public void setSection(Section newSection) {
		if (newSection != eInternalContainer() || (eContainerFeatureID() != SitePackage.RAW_ENTITY_TABLE_PAGE__SECTION && newSection != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.RAW_ENTITY_TABLE_PAGE__SECTION, newSection, newSection));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SitePackage.RAW_ENTITY_TABLE_PAGE__PARAMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SitePackage.RAW_ENTITY_TABLE_PAGE__NAME:
				return getName();
			case SitePackage.RAW_ENTITY_TABLE_PAGE__MOUNT_POINT:
