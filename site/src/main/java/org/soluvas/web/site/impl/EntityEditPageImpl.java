...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Entity Edit Page</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.soluvas.web.site.impl.EntityEditPageImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.EntityEditPageImpl#getMountPoint <em>Mount Point</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.EntityEditPageImpl#getParams <em>Params</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.EntityEditPageImpl#getSection <em>Section</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.EntityEditPageImpl#getEntityClass <em>Entity Class</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EntityEditPageImpl extends EObjectImpl implements EntityEditPage {
	/**
	...
	protected EClass eStaticClass() {
		return SitePackage.Literals.ENTITY_EDIT_PAGE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.ENTITY_EDIT_PAGE__NAME, oldName, name));
	}
	...
	public EList<PageParam> getParams() {
		if (params == null) {
			params = new EObjectContainmentEList<PageParam>(PageParam.class, this, SitePackage.ENTITY_EDIT_PAGE__PARAMS);
		}
		return params;
	}
	...
	public Section getSection() {
		if (eContainerFeatureID() != SitePackage.ENTITY_EDIT_PAGE__SECTION) return null;
	...
	public NotificationChain basicSetSection(Section newSection, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newSection, SitePackage.ENTITY_EDIT_PAGE__SECTION, msgs);
		return msgs;
	}
	...
	public void setSection(Section newSection) {
		if (newSection != eInternalContainer() || (eContainerFeatureID() != SitePackage.ENTITY_EDIT_PAGE__SECTION && newSection != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.ENTITY_EDIT_PAGE__SECTION, newSection, newSection));
	}
	...
	public void setEntityClass(String newEntityClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.ENTITY_EDIT_PAGE__ENTITY_CLASS, oldEntityClass, entityClass));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SitePackage.ENTITY_EDIT_PAGE__SECTION:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SitePackage.ENTITY_EDIT_PAGE__PARAMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SitePackage.ENTITY_EDIT_PAGE__NAME:
				return getName();
			case SitePackage.ENTITY_EDIT_PAGE__MOUNT_POINT:
				return getMountPoint();
			case SitePackage.ENTITY_EDIT_PAGE__PARAMS:
				return getParams();
			case SitePackage.ENTITY_EDIT_PAGE__SECTION:
				return getSection();
			case SitePackage.ENTITY_EDIT_PAGE__ENTITY_CLASS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == EntityPage.class) {
			switch (derivedFeatureID) {
				case SitePackage.ENTITY_EDIT_PAGE__ENTITY_CLASS: return SitePackage.ENTITY_PAGE__ENTITY_CLASS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == EntityPage.class) {
			switch (baseFeatureID) {
				case SitePackage.ENTITY_PAGE__ENTITY_CLASS: return SitePackage.ENTITY_EDIT_PAGE__ENTITY_CLASS;
				default: return -1;
			}
		}
