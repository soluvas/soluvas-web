 ...
 * <ul>
 *   <li>{@link org.soluvas.web.site.impl.UriPatternPageSelectorImpl#getPattern <em>Pattern</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UriPatternPageSelectorImpl extends EObjectImpl implements UriPatternPageSelector {
	...
	protected EClass eStaticClass() {
		return SitePackage.Literals.URI_PATTERN_PAGE_SELECTOR;
	}
	...
	public void setPattern(String newPattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.URI_PATTERN_PAGE_SELECTOR__PATTERN, oldPattern, pattern));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SitePackage.URI_PATTERN_PAGE_SELECTOR__PATTERN:
				return getPattern();
		}
