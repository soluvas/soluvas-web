...
public class SiteSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SitePackage.GOOGLE_PLUS_SYS_CONFIG: {
				GooglePlusSysConfig googlePlusSysConfig = (GooglePlusSysConfig)theEObject;
				T result = caseGooglePlusSysConfig(googlePlusSysConfig);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SitePackage.BING_SYS_CONFIG: {
				BingSysConfig bingSysConfig = (BingSysConfig)theEObject;
				T result = caseBingSysConfig(bingSysConfig);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SitePackage.ZENDESK_CONFIG: {
				ZendeskConfig zendeskConfig = (ZendeskConfig)theEObject;
				T result = caseZendeskConfig(zendeskConfig);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Google Plus Sys Config</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Google Plus Sys Config</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGooglePlusSysConfig(GooglePlusSysConfig object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Bing Sys Config</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Bing Sys Config</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Zendesk Config</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Zendesk Config</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
