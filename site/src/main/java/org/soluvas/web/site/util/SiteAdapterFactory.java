...
public class SiteAdapterFactory extends AdapterFactoryImpl {
	...
	protected SiteSwitch<Adapter> modelSwitch =
		new SiteSwitch<Adapter>() {
			...
			@Override
			public Adapter caseStarterSysConfig(StarterSysConfig object) {
				return createStarterSysConfigAdapter();
			}
			@Override
			public Adapter caseZendeskConfig(ZendeskConfig object) {
			...
			@Override
			public Adapter caseZendeskChatSysConfig(ZendeskChatSysConfig object) {
				return createZendeskChatSysConfigAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.soluvas.web.site.StarterSysConfig <em>Starter Sys Config</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createStarterSysConfigAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.soluvas.web.site.ZendeskConfig <em>Zendesk Config</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.soluvas.web.site.ZendeskChatSysConfig <em>Zendesk Chat Sys Config</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createZendeskChatSysConfigAdapter() {
		return null;
	}
