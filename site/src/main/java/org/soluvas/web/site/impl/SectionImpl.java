...
public class SectionImpl extends EObjectImpl implements Section {
	...
	protected EClass eStaticClass() {
		return SitePackage.Literals.SECTION;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.SECTION__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.SECTION__NAME, oldName, name));
	}
