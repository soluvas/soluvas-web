 ...
 * <ul>
 *   <li>{@link org.soluvas.web.site.impl.PageTitleImpl#getMain <em>Main</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.PageTitleImpl#getPrefixes <em>Prefixes</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.PageTitleImpl#getSuffixes <em>Suffixes</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.PageTitleImpl#getPrefixSeparator <em>Prefix Separator</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.PageTitleImpl#getSuffixSeparator <em>Suffix Separator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PageTitleImpl extends EObjectImpl implements PageTitle {
	...
	protected EClass eStaticClass() {
		return SitePackage.Literals.PAGE_TITLE;
	}
	...
	public void setMain(String newMain) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.PAGE_TITLE__MAIN, oldMain, main));
	}
	...
	public EList<String> getPrefixes() {
		if (prefixes == null) {
			prefixes = new EDataTypeUniqueEList<String>(String.class, this, SitePackage.PAGE_TITLE__PREFIXES);
		}
		return prefixes;
	}
	...
	public EList<String> getSuffixes() {
		if (suffixes == null) {
			suffixes = new EDataTypeUniqueEList<String>(String.class, this, SitePackage.PAGE_TITLE__SUFFIXES);
		}
		return suffixes;
	}
	...
	public void setPrefixSeparator(String newPrefixSeparator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.PAGE_TITLE__PREFIX_SEPARATOR, oldPrefixSeparator, prefixSeparator));
	}
	...
	public void setSuffixSeparator(String newSuffixSeparator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.PAGE_TITLE__SUFFIX_SEPARATOR, oldSuffixSeparator, suffixSeparator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SitePackage.PAGE_TITLE__MAIN:
				return getMain();
			case SitePackage.PAGE_TITLE__PREFIXES:
				return getPrefixes();
			case SitePackage.PAGE_TITLE__SUFFIXES:
				return getSuffixes();
			case SitePackage.PAGE_TITLE__PREFIX_SEPARATOR:
				return getPrefixSeparator();
			case SitePackage.PAGE_TITLE__SUFFIX_SEPARATOR:
