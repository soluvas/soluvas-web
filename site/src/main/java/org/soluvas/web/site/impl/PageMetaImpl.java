 ...
 * <ul>
 *   <li>{@link org.soluvas.web.site.impl.PageMetaImpl#getIcon <em>Icon</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.PageMetaImpl#getLanguageCode <em>Language Code</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.PageMetaImpl#getOpenGraph <em>Open Graph</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.PageMetaImpl#getOpenGraphImage <em>Open Graph Image</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.PageMetaImpl#getOpenGraphVideo <em>Open Graph Video</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.PageMetaImpl#getOpenGraphAudio <em>Open Graph Audio</em>}</li>
...
public class PageMetaImpl extends EObjectImpl implements PageMeta {
	...
	public NotificationChain basicSetIcon(PageIcon newIcon, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SitePackage.PAGE_META__ICON, oldIcon, newIcon);
	...
	public void setIcon(PageIcon newIcon) {
		if (newIcon != icon) {
			...
			if (icon != null)
				msgs = ((InternalEObject)icon).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SitePackage.PAGE_META__ICON, null, msgs);
			if (newIcon != null)
				msgs = ((InternalEObject)newIcon).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SitePackage.PAGE_META__ICON, null, msgs);
			msgs = basicSetIcon(newIcon, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.PAGE_META__ICON, newIcon, newIcon));
	}
	...
	public void setLanguageCode(String newLanguageCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.PAGE_META__LANGUAGE_CODE, oldLanguageCode, languageCode));
	}
	...
	public NotificationChain basicSetOpenGraph(OpenGraphMeta newOpenGraph, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SitePackage.PAGE_META__OPEN_GRAPH, oldOpenGraph, newOpenGraph);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOpenGraph(OpenGraphMeta newOpenGraph) {
		if (newOpenGraph != openGraph) {
			NotificationChain msgs = null;
			if (openGraph != null)
				msgs = ((InternalEObject)openGraph).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SitePackage.PAGE_META__OPEN_GRAPH, null, msgs);
			if (newOpenGraph != null)
				msgs = ((InternalEObject)newOpenGraph).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SitePackage.PAGE_META__OPEN_GRAPH, null, msgs);
			msgs = basicSetOpenGraph(newOpenGraph, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.PAGE_META__OPEN_GRAPH, newOpenGraph, newOpenGraph));
	}
	...
	public NotificationChain basicSetOpenGraphImage(OpenGraphImage newOpenGraphImage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SitePackage.PAGE_META__OPEN_GRAPH_IMAGE, oldOpenGraphImage, newOpenGraphImage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOpenGraphImage(OpenGraphImage newOpenGraphImage) {
		if (newOpenGraphImage != openGraphImage) {
			...
			if (openGraphImage != null)
				msgs = ((InternalEObject)openGraphImage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SitePackage.PAGE_META__OPEN_GRAPH_IMAGE, null, msgs);
			if (newOpenGraphImage != null)
				msgs = ((InternalEObject)newOpenGraphImage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SitePackage.PAGE_META__OPEN_GRAPH_IMAGE, null, msgs);
			msgs = basicSetOpenGraphImage(newOpenGraphImage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.PAGE_META__OPEN_GRAPH_IMAGE, newOpenGraphImage, newOpenGraphImage));
	}
	...
	public NotificationChain basicSetOpenGraphVideo(OpenGraphVideo newOpenGraphVideo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SitePackage.PAGE_META__OPEN_GRAPH_VIDEO, oldOpenGraphVideo, newOpenGraphVideo);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOpenGraphVideo(OpenGraphVideo newOpenGraphVideo) {
		if (newOpenGraphVideo != openGraphVideo) {
			...
			if (openGraphVideo != null)
				msgs = ((InternalEObject)openGraphVideo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SitePackage.PAGE_META__OPEN_GRAPH_VIDEO, null, msgs);
			if (newOpenGraphVideo != null)
				msgs = ((InternalEObject)newOpenGraphVideo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SitePackage.PAGE_META__OPEN_GRAPH_VIDEO, null, msgs);
			msgs = basicSetOpenGraphVideo(newOpenGraphVideo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.PAGE_META__OPEN_GRAPH_VIDEO, newOpenGraphVideo, newOpenGraphVideo));
	}
	...
	public NotificationChain basicSetOpenGraphAudio(OpenGraphAudio newOpenGraphAudio, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SitePackage.PAGE_META__OPEN_GRAPH_AUDIO, oldOpenGraphAudio, newOpenGraphAudio);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOpenGraphAudio(OpenGraphAudio newOpenGraphAudio) {
		if (newOpenGraphAudio != openGraphAudio) {
			...
			if (openGraphAudio != null)
				msgs = ((InternalEObject)openGraphAudio).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SitePackage.PAGE_META__OPEN_GRAPH_AUDIO, null, msgs);
			if (newOpenGraphAudio != null)
				msgs = ((InternalEObject)newOpenGraphAudio).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SitePackage.PAGE_META__OPEN_GRAPH_AUDIO, null, msgs);
			msgs = basicSetOpenGraphAudio(newOpenGraphAudio, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.PAGE_META__OPEN_GRAPH_AUDIO, newOpenGraphAudio, newOpenGraphAudio));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SitePackage.PAGE_META__ICON:
				return basicSetIcon(null, msgs);
			case SitePackage.PAGE_META__OPEN_GRAPH:
				return basicSetOpenGraph(null, msgs);
			case SitePackage.PAGE_META__OPEN_GRAPH_IMAGE:
				return basicSetOpenGraphImage(null, msgs);
			case SitePackage.PAGE_META__OPEN_GRAPH_VIDEO:
				return basicSetOpenGraphVideo(null, msgs);
			case SitePackage.PAGE_META__OPEN_GRAPH_AUDIO:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SitePackage.PAGE_META__ICON:
				return getIcon();
			case SitePackage.PAGE_META__LANGUAGE_CODE:
