 ...
 * <ul>
 *   <li>{@link org.soluvas.web.site.impl.PageIconImpl#getFaviconUri <em>Favicon Uri</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.PageIconImpl#getIcon57Uri <em>Icon57 Uri</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.PageIconImpl#getIcon72Uri <em>Icon72 Uri</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.PageIconImpl#getIcon114Uri <em>Icon114 Uri</em>}</li>
 *   <li>{@link org.soluvas.web.site.impl.PageIconImpl#getIcon144Uri <em>Icon144 Uri</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PageIconImpl extends EObjectImpl implements PageIcon {
	...
	protected EClass eStaticClass() {
		return SitePackage.Literals.PAGE_ICON;
	}
	...
	public void setFaviconUri(String newFaviconUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.PAGE_ICON__FAVICON_URI, oldFaviconUri, faviconUri));
	}
	...
	public void setIcon57Uri(String newIcon57Uri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.PAGE_ICON__ICON57_URI, oldIcon57Uri, icon57Uri));
	}
	...
	public void setIcon72Uri(String newIcon72Uri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.PAGE_ICON__ICON72_URI, oldIcon72Uri, icon72Uri));
	}
	...
	public void setIcon114Uri(String newIcon114Uri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.PAGE_ICON__ICON114_URI, oldIcon114Uri, icon114Uri));
	}
	...
	public void setIcon144Uri(String newIcon144Uri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.PAGE_ICON__ICON144_URI, oldIcon144Uri, icon144Uri));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SitePackage.PAGE_ICON__FAVICON_URI:
				return getFaviconUri();
			case SitePackage.PAGE_ICON__ICON57_URI:
				return getIcon57Uri();
			case SitePackage.PAGE_ICON__ICON72_URI:
				return getIcon72Uri();
			case SitePackage.PAGE_ICON__ICON114_URI:
				return getIcon114Uri();
			case SitePackage.PAGE_ICON__ICON144_URI:
