...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Child Contributor</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class ChildContributorImpl extends EObjectImpl implements ChildContributor {
	...
	public void setPageClassName(String newPageClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComposePackage.CHILD_CONTRIBUTOR__PAGE_CLASS_NAME, oldPageClassName, pageClassName));
	}
	...
	public void setTargetPath(String newTargetPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComposePackage.CHILD_CONTRIBUTOR__TARGET_PATH, oldTargetPath, targetPath));
	}
	...
	public void setClassName(String newClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComposePackage.CHILD_CONTRIBUTOR__CLASS_NAME, oldClassName, className));
	}
	...
	public void setFactoryBean(String newFactoryBean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComposePackage.CHILD_CONTRIBUTOR__FACTORY_BEAN, oldFactoryBean, factoryBean));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ComposePackage.CHILD_CONTRIBUTOR__CLASS_NAME:
				return getClassName();
