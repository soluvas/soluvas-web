...
We use lookfirst's fork of RequireJS. See https://github.com/jrburke/requirejs/issues/376
for reasons.

1. Get the fork from https://github.com/lookfirst/requirejs
2. Copy require.js as @/org.soluvas.web.bootstrap/src/main/resources/js/require-2.1.4-lookfirst.js@
