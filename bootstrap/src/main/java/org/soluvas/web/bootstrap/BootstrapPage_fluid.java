...
public class BootstrapPage_fluid extends ExtensiblePage {
	...
	private static final Logger log = LoggerFactory
			.getLogger(BootstrapPage_fluid.class);
...
//			add(feedbackPanel);
		...
		final IModel<String> pageJavaScriptSourcesModel = new LoadableDetachableModel<String>() {
			...
			protected String load() {
				...
				final AmdDependencyVisitor amdDependencyVisitor = new AmdDependencyVisitor(
						dependencies);
				amdDependencyVisitor.component(BootstrapPage_fluid.this, null);
				...
				jsSourceVisitor.component(BootstrapPage_fluid.this, null);
	...
	public BootstrapPage_fluid(boolean sidebarVisible) {
		this();
		if (!sidebarVisible) {
