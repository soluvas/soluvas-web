...
//		getModel().getObject().getd
        ...
        final Select2Choice<Mixin> mixinChoices = new Select2Choice<>("defaultMixin", curMixinModel, new ChoiceProvider<Mixin>() {
            @Override
            public String getDisplayValue(Mixin choice) {
                return choice.getDisplayName();
            }

            @Override
            public String getIdValue(Mixin choice) {
