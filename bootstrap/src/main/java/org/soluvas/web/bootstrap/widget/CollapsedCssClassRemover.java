...
/**
 * Bootstrap-enhances a component (usually {@link WebMarkupContainer} @{code ul}) by removing
 * {@code class="collapsed"} if at least one of the provided {@link BookmarkablePageLink} links to the current {@link Page}.
 * 
 * <p>Usage:
 * 
 * <pre>{@literal
 ...
 * @author ceefour
 */
public class CollapsedCssClassRemover extends CssClassNameRemover {
	
	private static final long serialVersionUID = 1L;
	
	public CollapsedCssClassRemover(final BookmarkablePageLink<?>... links) {
