...
public class TermTablePanel extends Panel {
	...
	private static final Logger log = LoggerFactory.getLogger(TermTablePanel.class);
	
	public TermTablePanel(final String id, final IModel<TermKind> termKindModel,
	...
	private class Term2TableForm extends Form<Void> {
		...
		public Term2TableForm(final String id, final IModel<TermKind> termKindModel,
			...
			final SortableDataProvider<Term2, String> termDp = new TermSDP(termKindModel);
