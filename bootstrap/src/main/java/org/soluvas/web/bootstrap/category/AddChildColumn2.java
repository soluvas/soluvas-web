...
public class AddChildColumn2 extends
		AbstractColumn<Category2, String> {
	
	private final Class<? extends Page> addPage;

	public AddChildColumn2(IModel<String> displayModel, Class<? extends Page> addPage) {
		super(displayModel);
